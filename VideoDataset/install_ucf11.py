...
def generate_and_save_labels():
    ...
    write_to_csv(train, os.path.join('.', '/content/Drowning-Risk-Analysis/VideoDataset/train_map.csv'))
    write_to_csv(test, os.path.join('.', '/content/Drowning-Risk-Analysis/VideoDataset/test_map.csv'))
