...
if __name__=='__main__':
    ...
    train_reader = VideoReader(os.path.join(data_path, '/content/Drowning-Risk-Analysis/VideoDataset/train_map.csv'), num_output_classes, True)
    test_reader  = VideoReader(os.path.join(data_path, '/content/Drowning-Risk-Analysis/VideoDataset/test_map.csv'), num_output_classes, False)
